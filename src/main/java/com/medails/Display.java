...
{    
    ...
    public JButton               btTVA;                  { btTVA                = new JButton           ("Calculer");}           // B3 - Calcule TVA (BP)
    ...
    public JButton               btOpenFacture;          { btOpenFacture        = new JButton           ("Ouvrir");}             // E1 - Ouvrir facture
    public JButton               btSearchFacture;        { btSearchFacture      = new JButton           ("Parcourir");}          // E2 - Parcourir facture
    ...
    public JButton               btOpenDecla;            { btOpenDecla          = new JButton           ("Ouvrir");}             // H1 - Ouvrir déclaration
    public JButton               btSearchDecla;          { btSearchDecla        = new JButton           ("Parcourir");}          // H2 - Parcourir déclaration
    ...
    public JButton               btSave;                 { btSave               = new JButton           ("Enregistrer");}        // K1 - Enregistrer
    public JButton               btReset1;               { btReset1             = new JButton           ("RAZ");}                // K2 - RAZ

    /*********** Onglet 2 ***************/
    public final int             MINRANGE_GRAPHIC         = 10000;
    public final int             MAXRANGE_GRAPHIC         = 20000;                                      // XX - Gestionnaire d'échelle graphique
    public JSlider               sliPan2;                { sliPan2              = new JSlider           (JSlider.HORIZONTAL, MINRANGE_GRAPHIC, MAXRANGE_GRAPHIC, MINRANGE_GRAPHIC);}             
    ...
    public JButton               btReset2;               { btReset2             = new JButton           ("RAZ");}                // D3 - RAZ

    /*********** Onglet 3 ***************/ 
    public final int             MINRANGE_DECADE          = 30000;
    public final int             MINRANGE_DEDUCTION       = 3000;
    public final int             MAXRANGE_DECADE          = 100000;                                     // XX - Gestionnaire d'échelle graphique
    public JSlider               sliDecade;              { sliDecade            = new JSlider           (JSlider.HORIZONTAL, MINRANGE_DECADE, MAXRANGE_DECADE, MINRANGE_DECADE);}       
    public JSlider               sliDeduction;           { sliDeduction         = new JSlider           (JSlider.HORIZONTAL, MINRANGE_DEDUCTION, MAXRANGE_GRAPHIC, MINRANGE_DEDUCTION);}   
    ...
    public JCheckBox             cckTotal;               { cckTotal             = new JCheckBox         ("", false);}   // A3 - Années
    ...
    public JButton               btOpenDeduction;        { btOpenDeduction      = new JButton           ("Ouvrir");}             // C1 - Ouvrir Déduction
    public JButton               btSearchDeduction;      { btSearchDeduction    = new JButton           ("Parcourir");}          // C2 - Parcourir Déduction
    public JButton               btPDF3;                 { btPDF3               = new JButton           ("...");}                // ... -  Renseignement du répertoire -> Déclaration
    ...
    public JButton               btSaveDeduction;        { btSaveDeduction      = new JButton           ("Enregistrer");}        // F1 - Enregistrer
    public JButton               btResetDeduction;       { btResetDeduction     = new JButton           ("RAZ");}                // F2 - RAZ
    ...
    ***********************************************************/
    ...
    { 
        ...
        // XX - Slide
        gbc.insets = new Insets(0, 10, 10, 10);
        JLabel labSliPan2 = new JLabel("Annuel/Mensuel : ");
        addComposant(pan2, labSliPan2, 0, 0, 1);
        addComposant(pan2, sliPan2, 2, 0, 3); 
    ...
    ***********************************************************/
    ...
    public void pan3Position()
    {
        ...
        // XX - Slide
        gbc.insets = new Insets(0, 10, 10, 10);
        JLabel labSliDecade = new JLabel("Décénie : ");
        JLabel labSliDeduction = new JLabel("Déductible : ");
        addComposant(pan3, labSliDecade, 0, 0, 1);
        addComposant(pan3, labSliDeduction, 0, 1, 1);
        addComposant(pan3, sliDecade, 1, 0, 3); 
        addComposant(pan3, sliDeduction, 1, 1, 3); 
        ...
        addComposant(pan3, labYearsDeduction, 1, 6, 1);
        addComposant(pan3, boxYearsDeduction, 1, 8, 1);    

        // A3 - Déduction
        JLabel labcckTotal = new JLabel("Déduction");
        cckTotal.setBackground(Color.LIGHT_GRAY);
        addComposant(pan3, labcckTotal, 2, 6, 1);
        addComposant(pan3, cckTotal, 2, 8, 1);  
        ...
        // C1 - Ouvrir Déduction
        gbc.insets = new Insets(0, 65, 10, 10);
        addComposant(pan3, btOpenDeduction, 1, 16, 1);

        // C2 - Parcourir Déduction
        gbc.insets = new Insets(0, 10, 10, 10);
        addComposant(pan3, btSearchDeduction, 2, 16, 1);

        // Renseignement du répertoire -> Déduction
        gbc.insets = new Insets(0, 0, 10, 330);
        btPDF3.setPreferredSize(new Dimension(20,18));
        addComposant(pan3, btPDF3, 0, 18, 3);
        ...
        // /************************ Enregistrer ************************/
        // F1 - Enregistrer
        addComposant(pan3, btSaveDeduction, 0, 22, 2);

        // F2 - RAZ
        addComposant(pan3, btResetDeduction, 1, 22, 2);
    }
}
